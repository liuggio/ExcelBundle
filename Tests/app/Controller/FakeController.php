...
class FakeController extends Controller
{
    public function streamAction()
    {
        ...
        // create the writer
        $writer = $this->get(Factory::class)->createWriter($phpExcelObject, 'Excel5');
        // create the response
        $response = $this->get(Factory::class)->createStreamedResponse($writer);
        // adding headers
    ...
    public function readerAction()
    {
        ...
        $factory = $this->get(Factory::class);
        // create a reader
    ...
    {
        $phpExcelObject = $this->get(Factory::class)->createPHPExcelObject();

        $htmlHelper = $this->get(Factory::class)->createHelperHTML();
